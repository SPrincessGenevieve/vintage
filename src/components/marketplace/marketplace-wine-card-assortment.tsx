...
import { Plus, Minus, Grape, MapPinned } from "lucide-react";
...
export default function MarketplaceWineCardAssortment({
  parent,
  vintage,
}: {
  parent: AssortmentList;
  vintage: AssortmentDetails[];
}) {
