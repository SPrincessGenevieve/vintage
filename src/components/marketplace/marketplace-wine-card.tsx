...
export default function MarketplaceWineCard({
  item,
  vintage,
  year,
  parent,
  ...
  const regionFilter = !item.fromm ? "" : item.fromm;
  ...
  const { setUserDetails, yearSelect, selected_case_size } = useUserContext();
  ...
  setUserDetails({
    selected_case_size: selectedCaseSize,
  });
  ...
  useEffect(() => {
    // Handle wine_name specific conditions first
    if (
      wine_name === "Masseto, Toscana" ||
      wine_name === "Screaming Eagle, Cabernet Sauvignon, Oakville"
    ) {
      setSelectedCaseSize(3);
    } else {
      // Handle regionFilter conditions for wines other than the above
  ...
  return (
    <div className="flex flex-col gap-2">
              ...
              <div className="relative  border-gray-200 flex h-auto w-full border rounded-2xl items-center justify-center">
                ...
                <div className="flex w-full h-full items-center justify-center p-10">
                  <Image
                    ...
                    alt="card"
                    className="w-auto h-full max-h-[300px] z-10"
                  />
                </div>
              </div>
            ) : (
            ...
            <div className="num-group-port w-[100%] flex justify-between">
              ...
              <div className=" h-full flex flex-col justify-between">
                ...
                {vintage.is_very_special !== true ? (
                  ...
                  <div className="w-full text-center h-full flex items-center right-0 bottom-0">
                    <p className="font-semibold text-[#104144]">
                      FOR REQUEST ONLY
                    </p>
                  </div>
                )}
      ...
      <div className="pb-2 port-charts-cont w-full h-auto">
        <WineChart region={item?.fromm} parent={item} item={vintage} />
      </div>
    </div>
  );
}
